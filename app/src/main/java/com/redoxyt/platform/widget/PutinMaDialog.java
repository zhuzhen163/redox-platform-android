...
public class PutinMaDialog extends AlertDialog {
    ...
    public PutinMaDialog(Context context, int layoutId, double widthPecent, double heightPecent) {
        super(context);
    ...
    public PutinMaDialog(Context context, int layoutId, int styleId, double widthPecent, double heightPecent) {
    ...
    private void initSize() {
        ...
        if (widthPecent != 0) {
            params.width = (int) (AppUtils.getScreenWidth() * widthPecent);
        }
        if (heightPecent != 0) {
            params.height = (int) (AppUtils.getScreenHeight() * heightPecent);
        }
    ...
    public void changBg(PutinMaDialog crownDialog, float f) {
        Window window = crownDialog.getWindow();
