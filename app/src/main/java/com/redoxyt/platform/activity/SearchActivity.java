...
//        super.setStatusBar();
    ...
    private void setSearchList() {
        lv_list.setLayoutManager(new LinearLayoutManager(SearchActivity.this));
        lv_list.setHasFixedSize(true);
        lv_list.refresh();
        queryAdapter = new ReservationQueryAdapter(SearchActivity.this);
    ...
    public void getByReserveList(String input) {
        ...
        OkGo.<QueryVoLzyResponse<ReservationListBean>>get(BaseUrl.YT_Base + BaseUrl.getByReserveList)
                .params(params)
                .execute(new QueryVoDialogCallback<QueryVoLzyResponse<ReservationListBean>>(SearchActivity.this, true) {
                    @Override
