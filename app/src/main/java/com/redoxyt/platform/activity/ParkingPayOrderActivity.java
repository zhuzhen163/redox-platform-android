...
public class ParkingPayOrderActivity extends BaseActivity {
     ...
     * 支付统一下单接口
     */
    public void parkingFeePay(String reserveId) {
        ...
        OkGo.<QueryVoLzyResponse<PayBean>>post(BaseUrl.YT_Base + BaseUrl.parkingFeePay)
                .params(params)
                .execute(new QueryVoDialogCallback<QueryVoLzyResponse<PayBean>>(ParkingPayOrderActivity.this, true) {
                    @Override
    ...
    public void wechatPayRecord() {
        ...
        bean.setAttachType("parking_fee_pay");
        String detail = new Gson().toJson(bean);
        OkGo.<QueryVoLzyResponse<String>>post(BaseUrl.YT_Base + BaseUrl.wechatPayRecord)
                .upJson(detail)
                .execute(new QueryVoDialogCallback<QueryVoLzyResponse<String>>(ParkingPayOrderActivity.this, true) {
                    @Override
                    public void onFail(int code, String desc) {
                        super.onFail(code, desc);
                        showToast(desc);
