...
public class AdminReservationListActivity extends BaseActivity {
    ...
    @Override
    public int setView() {
        return R.layout.acitivty_admin_reservation_list;
    }
    ...
    private void setListView() {
        lv_list.setLayoutManager(new LinearLayoutManager(AdminReservationListActivity.this));
        lv_list.setHasFixedSize(true);
        lv_list.refresh();
        recordAdapter = new ReservationRecordAdapter(AdminReservationListActivity.this);
    ...
    public void getByReserveList(String searchText) {
        ...
        params.put("needWarehouse",1);
        params.put("page",page);
        params.put("rows",20);
        params.put("searchText",searchText);
        OkGo.<QueryVoLzyResponse<ReservationListBean>>get(BaseUrl.YT_Base + BaseUrl.getByReserveList)
                .params(params)
                .execute(new QueryVoDialogCallback<QueryVoLzyResponse<ReservationListBean>>(AdminReservationListActivity.this, true) {
                    @Override
