...
import com.redoxyt.platform.activity.AIBuildReservationActivity;
...
public class AIBuildTimeAdapter extends ListBaseAdapter <ReservationTimeBean>{

    TextView tv_month,tv_week,tv_status;
    LinearLayout ll_bg;

    private OnTimeClickListener timeClickListener;
    AIBuildReservationActivity context;

    public AIBuildTimeAdapter(AIBuildReservationActivity context) {
        super(context);
