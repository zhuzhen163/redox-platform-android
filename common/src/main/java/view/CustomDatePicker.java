...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private TextView mTvYear, mTvMonth, mTvDay, mTvHourUnit, mTvMinuteUnit;
    ...
    public void setTitle(String tvTilte) {
        title.setText(tvTilte);
    }
     ...
     * 设置日期控件只显示年月
     */
    public void setCanOnlyShowYearAndMonth(boolean canShowPreciseTime) {
     ...
     * 设置日期控件只显示时和分
     */
    public void setCanOnlyShowMiniteAndUnit(boolean canShowPreciseTime) {
    ...
    public void setCanShowAnim(boolean canShowAnim) {
       ...
       /* mDpvYear.setCanShowAnim(canShowAnim);
        ...
        // TODO: 2019/7/9 测试说关闭所有的动画
        mDpvYear.setCanShowAnim(false);
        mDpvMonth.setCanShowAnim(false);
        mDpvDay.setCanShowAnim(false);
        mDpvHour.setCanShowAnim(false);
        mDpvMinute.setCanShowAnim(false);
    }
